...
call s:HL('Type', 'none', 'none', 'bold')
call s:HL('Typedef', 'none', 'none', 'bold')
call s:HL('StorageClass', 'none', 'none', 'bold')
call s:HL('Structure', 'none', 'none', 'bold')

call s:HL('Exception', 'nred', 'none', 'bold')

call s:HL('Error', 'gray24', 'bred', 'bold')
call s:HL('Debug', 'gray24', 'none', 'bold')
call s:HL('Ignore', 'gray09', 'none', 'none')
" }}}
...
call s:HL('CtrlPNoEntries', 'vhcontrast', 'none', 'none')
...
call s:HL('cssClassName', 'gray09', 'none', 'none')
call s:HL('cssClassNameDot', 'gray09', 'none', 'none')
...
call s:HL('VimFuncName', 'none', 'none', 'bold')
...
call s:HL('texRefZone', 'hcontrast', 'none', 'none')
...
call s:HL('markdownUrl', 'hcontrast', 'none', 'none')
call s:HL('markdownLinkDelimiter', 'hcontrast', 'none', 'none')
call s:HL('markdownUrldelimiter', 'hcontrast', 'none', 'none')
call s:HL('markdownCodeDelimiter', 'gray09', 'vlcontrast', 'none')
call s:HL('markdownCode', 'gray09', 'vlcontrast', 'none')
call s:HL('markdownCodeBlock', 'gray09', 'vlcontrast', 'none')
" }}}

" Python {{{
call s:HL('pythonBuiltin', 'none', 'none', 'bold')
