...
call s:HL('rubyRegexp', 'gray12', 'vlcontrast', 'none')
call s:HL('rubyRegexpCharClass', 'gray12', 'vlcontrast', 'none')
call s:HL('rubyRegexpAnchor', 'gray12', 'vlcontrast', 'none')
call s:HL('rubyRegexpQuantifier', 'gray12', 'vlcontrast', 'none')
call s:HL('rubyRegexpDelimiter', 'gray12', 'vlcontrast', 'none')
call s:HL('rubyStringDelimiter', 'gray12', 'vlcontrast', 'none')
